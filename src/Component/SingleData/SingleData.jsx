...
const SingleData = (props) => {
    ...
    const { image, features, published_in, name, id } = props.singleData;
    const handleId =(id) =>{
        console.log(id)
    }
    return (
                ...
                <div className="card-body">
                    ...
                    <div className='flex justify-between'>
                        ...
                        <div onClick={() => handleId(id)}>
                            <button className="btn cursor-pointer" onClick={() => window.my_modal_4.showModal()}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
